...
<div class="flex w-1/4 flex-col">
  ...
  <select id="odontologist_name" class="mt-2 bg-white rounded border-2 border-black" on:change={changeOdontologist}>
...
{#if status === Status.SUCCESS}
  <div class="mt-4">
    <p class="text-center text-xl">Appointment added successfully!</p>
